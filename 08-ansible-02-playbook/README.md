...
9. Подготовьте README.md-файл по своему playbook. В нём должно быть описано: что делает playbook, какие у него есть параметры и теги.
  >[README.md-файл](https://github.com/YTimashev/ansible_lesson/edit/main/08-ansible-02-playbook/README.md)
11. Готовый playbook выложите в свой репозиторий, поставьте тег `08-ansible-02-playbook` на фиксирующий коммит, в ответ предоставьте ссылку на него.
  > [Ссылка на PLAYBOOK](https://github.com/YTimashev/ansible_lesson/tree/main/08-ansible-02-playbook/playbook)
