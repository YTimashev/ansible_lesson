...
>Из за недостатка времени (дедлайн), так и не разобрался как настроить оповещение при использовании панели Gauge, по этой причине малость поправил Dashdoard.
